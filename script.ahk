...
mainStashImg := A_Temp "\main-stash.png"
blueChestImg := A_Temp "\bau-azul.png"
...
Download(
    "https://github.com/Lovattows/tbh/blob/main/main-stash.png?raw=true",
    mainStashImg
)

Download(
    "https://github.com/Lovattows/tbh/blob/main/bau-azul.png?raw=true",
    blueChestImg
)
...
ClicarBauAzul()
{
    ...
    Loop
    {
        if !ImageSearch(&bx, &by, 0, 0, A_ScreenWidth, A_ScreenHeight, "*80 " blueChestImg)
            break

        MouseMove bx + 28, by + 15, 0
        Sleep 150
        Click "Left"

        ; espera o jogo reagir
        Sleep 1200
    }
}
...
RotinaCompleta()
{
   ...
   ;RIMEIRO PROCURA TODOS OS BAÚS AZUIS
    ClicarBauAzul()
	...
	if ImageSearch(&mx, &my, 0, 0, A_ScreenWidth, A_ScreenHeight, "*80 " mainStashImg)
	{
	    MouseMove mx + 28, my + 15, 15
	    Sleep 100
	    Click "Left"
	    Sleep 2000
	}
...
LimparArquivos(*)
{
    ...
    try FileDelete(mainStashImg)
    try FileDelete(blueChestImg)
}